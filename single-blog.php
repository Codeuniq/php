...
<body>
  ...
  <main id="main">
    ...
    <!--================Blog Area =================-->
    <section class="blog_area single-post-area section_gap" style="margin-top: -200px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-8 posts-list">
                  ...
                  $key=$_GET["id"];
                  $query=mysqli_query($con,"select * from `vlogs` WHERE `Video_Id`='$key' ORDER BY `Video_Count` DESC ");
                  while($row=mysqli_fetch_array($query)){
                  ?>
                    <div class="single-post row">
                        <div class="col-lg-12">
                            <div class="feature-img">
                                <!--<img class="img-fluid" src="../blog/img/blog/feature-img1.jpg" alt="">-->
                                <iframe width="750" height="350" src="https://www.youtube.com/embed/<?php echo $key; ?>?autoplay=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                            </div>                  
                        </div>
                        ...
                        <div class="col-lg-9 col-md-9 blog_details">
                            ...
                            <p class="excert">
                                <?php echo $row['Title']; ?> <br> Powered by Codeuniq
                            </p>
                            <p>
                                <b style="color: black;">#CoffinDance #Arduino #LatestTech</b>
                                <BR>
                                <?php echo $row['Description']; ?> 
                            </p>
                            <p>                               
                                Write us on : codeuniqprojects@gmail.com<br>
                                Malayalam tutorial Made by Sherin KR of Codeuniq<br>
                                <b style="color: black;"><?php echo $row['Tags']; ?> </b><br>
                                Latest tech<br>
                                Stay tuned for more
                            </p>
                            ...
                            ?>
                            <a href='<?php echo $file; ?>' class='primary_btn' style='<?php echo $val; ?>'><span><?php echo $row['Button_Head']; ?></span></a >

                            <a target="_blank" href="https://www.youtube.com/channel/UCPdUQF0fLsrmcqENU6-Biew" class="primary_btn"><span>Subscribe Our Chanel</span></a>
                             <BR>
                        </div>
                        <!--
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <img class="img-fluid" src="../blog/img/blog/post-img1.jpg" alt="">
                                </div>
                                <div class="col-6">
                                    <img class="img-fluid" src="../blog/img/blog/post-img2.jpg" alt="">
                                </div>  
                    ...
                    <div class="navigation-area">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
                                <div class="thumb">
                                    <a href="#"><img class="img-fluid" src="../blog/img/blog/prev.jpg" alt=""></a>
                                </div>
                                <div class="arrow">
                            ...
                            <div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
                                ...
                                <div class="thumb">
                                    <a href="#"><img class="img-fluid" src="../blog/img/blog/next.jpg" alt=""></a>
                                </div>                    
                            </div>                  
                        </div>
                    </div>
